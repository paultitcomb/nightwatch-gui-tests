module.exports = {
	'Mobile - click donate button goes to donate hub':
		'' +
		function(browser) {
			browser
	...
	'Mobile - when the menu is clicked, the sub menu is opened':
		'' +
		function(browser) {
			browser
				.resizeWindow(411, 731)
	...
	'Mobile - menu opens and search is performed with results':
		'' +
		function(browser) {
			browser
				.resizeWindow(411, 731)
	...
	'Desktop - Click donate button takes you to the donate hub':
		'' +
		function(browser) {
			browser
	...
	'Desktop - clicking search icon opens search box then closes it again on blur': function(browser) {
		browser
			.resizeWindow(1200, 800)
			.url('https://aem-staging-uk.stcdev.com')
			.waitForElementVisible('.search-btn-wrapper .search-btn', 20000)
